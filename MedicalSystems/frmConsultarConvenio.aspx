            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <form runat="server">
                        ...
                        <asp:ObjectDataSource ID="ObjectConvenio" runat="server" SelectMethod="ConsultarTodos" TypeName="MedicalSystems.controller.ConvenioController" DeleteMethod="RemoverConvenio" >
                            <DeleteParameters>
